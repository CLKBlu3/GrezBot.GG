...
MetaType::MetaType(const std::string & name, GrezBot & bot)
    : MetaType()
{
    m_bot = &bot;
    m_name = name;
...
MetaType::MetaType(const UnitType & unitType, GrezBot & bot)
{
    m_bot           = &bot;
    m_type          = MetaTypes::Unit;
    m_unitType      = unitType;
...
MetaType::MetaType(const CCUpgrade & upgradeType, GrezBot & bot)
{
    m_bot           = &bot;
    m_type          = MetaTypes::Upgrade;
